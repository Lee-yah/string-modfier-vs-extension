...
function activate(context) {
    ...
    const disposable = vscode.window.registerWebviewViewProvider(StringModifierViewProvider.viewType, provider, {
        webviewOptions: { retainContextWhenHidden: true }
    });
    context.subscriptions.push(disposable);
}
function deactivate() { }
class StringModifierViewProvider {
    extensionUri;
    static viewType = 'string-modifier.sidebar';
    constructor(extensionUri) {
        this.extensionUri = extensionUri;
    }
    getWebviewUri(webview, ...paths) {
